                    ...
                    <div class="col-sm-8 col-md-6 col-lg-5 col-xl-5">
                     <form name="form_editNote" action="javascript:void(null);" onsubmit="EditNote()" method="PUT" style="padding-bottom: 10px;">
                       <div class="form-group"> 
                        ...
                        <input type="text" class="form-control" name="name" value="{{ .Name }}" placeholder="Название" id="name" maxlength="20" required>
                       </div>
                       <div class="form-group"> 
                        <label for="rating">Оценка</label>
                        <input type="number" class="form-control" name="rating" value="{{ .Rating }}" min="1" max="5" id="rating" required>
                       </div>  
                       <div class="form-group"> 
                        <label for="note">Заметка</label>
                        <textarea class="form-control" name="note" id="description" rows="7" maxlength="255">{{ .Note }}</textarea>
                       </div>
                       <div class="form-group" style="display: none"> 
                        <label for="idnote">idNote</label>
                        <input type="number" class="form-control" name="idnote" value="{{ .Id }}" id="idnote" maxlength="30" required>
                       </div>
